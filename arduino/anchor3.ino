...
char anchor_addr[] = "50:d6:dc:44:c7:9d:E2:3A"; //#4
char tag_addr[] = "84:00:5B:D5:A9:9A:E2:3A";
float this_anchor_Adelay;
//calibrated Antenna Delay setting for this anchor
uint16_t Adelay = 16565;
//16634
//16580
//16565
...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if(strcmp(topic,"esp32/calibrasijarak")==0){
    ...
    uint16_t Adelay_delta = 100;
    float this_anchor_target_distance = 0;
    modecalibrasidelayantena=true;
    }
    if(strcmp(topic,"esp32/calibrasiantena3")==0){
    this_anchor_target_distance=messageTemp.toFloat();
    Serial.print("jaraaakkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk=");
        ...
        if(strcmp(topic,"esp32/comunicateanchor")==0){
          ...
          if(strcmp(myCharArray,"anchorantena3")==0){
...
client.publish("esp32/jarak3", msg);
...
//    }
  ...
  //////////////////////////////////////////////
  void listsubscribe(){
   client.subscribe("esp32/calibrasiantena3");
   client.subscribe("esp32/calibrasijarak");
   client.subscribe("esp32/comunicateanchor");
   client.subscribe("esp32/jarakcalibrasiantena3");
   }
