...
char anchor_addr[] = "4b:00:57:40:00:1a:64:c5"; //#4
char tag_addr[] = "84:00:5B:D5:A9:9A:E2:1A";
...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if(strcmp(topic,"esp32/calibrasiantena1")==0){
    this_anchor_target_distance=messageTemp.toFloat();}
    if(strcmp(topic,"esp32/comunicateanchor")==0){
      if(strcmp(myCharArray,"anchorantena1")==0 && modekalibrasiperhitunganruangan==true){
        DW1000Ranging.startAsTag(tag_addr, DW1000.MODE_LONGDATA_RANGE_LOWPOWER, false);
      }else{
        DW1000Ranging.startAsAnchor(anchor_addr, DW1000.MODE_LONGDATA_RANGE_LOWPOWER, false);}
        if(strcmp(myCharArray,"start")==0){
        modekalibrasiperhitunganruangan=true;}
      if(strcmp(myCharArray,"finish")==0){
      modekalibrasiperhitunganruangan=false;}
   }
   }
...
//      serializeJson(jsonDoc, jsonString);
  client.publish("esp32/jarak1", msg);
...
#define NUMBER_OF_DISTANCES 1
  ...
  //////////////////////////////////////////////
  void listsubscribe(){
   client.subscribe("esp32/calibrasiantena1");
   client.subscribe("esp32/calibrasijarak");
   client.subscribe("esp32/comunicateanchor");
   client.subscribe("esp32/jarakcalibrasiantena1");
   }
